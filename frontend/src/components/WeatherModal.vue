...
<template>
    <button v-if="!toggle" type="button" @click="() => toggle = !toggle" data-modal-target="defaultModal"
    ...
    <!-- Main modal -->
    <div v-if="toggle" id="defaultModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full h-full max-w-2xl md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <PageLoader v-else :load="isLoading"></PageLoader>
                <!-- Modal footer -->
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button data-modal-hide="defaultModal" type="button"
                    :disabled="isLoading"
                    @click="getWeatherDetails()"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Reload</button>
                    <button data-modal-hide="defaultModal" type="button" @click="() => toggle = !toggle"
